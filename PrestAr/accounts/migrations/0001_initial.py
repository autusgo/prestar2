    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educacion', models.CharField(choices=[('Primario incompleto', 'Primario incompleto'), ('prim_comp', 'Primario completo'), ('Primario completo', 'Secundario incompleto'), ('Secundario completo', 'Secundario completo'), ('Terciario incompleto', 'Terciario incompleto'), ('Terciario completo', 'Terciario completo'), ('Universitario incompleto', 'Universitario incompleto'), ('Universitario completo', 'Universitario completo')], max_length=200, null=True)),
